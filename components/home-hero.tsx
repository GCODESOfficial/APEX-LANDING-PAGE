...
export default function HomeHero() {
  ...
  <div className="relative flex md:flex-row flex-col items-center justify-center gap-10">
    {/* Left purple/blue glow */}
    <div className="absolute md:relative md:top-30 top-50 left-1/2 -translate-x-1/3 md:left-0 md:translate-x-0 md:w-[500px] w-[300px] md:h-[500px] h-[400px] rounded-full blur-[120px] bg-gradient-to-br from-[#6A00FF]/60 via-[#6A00FF]/80 to-[#00E6C3]"></div>

    {/* Right teal/green glow */}
    <div className="absolute md:relative md:right-0 md:left-auto md:-bottom-[28rem] md:w-[800px] w-[400px] md:h-[500px] h-[400px] rounded-full blur-[140px] bg-[#00E6C3]"></div>
  </div>
</div>
